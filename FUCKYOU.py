...
\033[1;32m               \033[1;32mAUTHOR       :  \033[1;32mSARDAR DANISH
\033[1;32m               \033[1;36mGITHUB       :  \033[1;33mSARDAR BRAND
...
clear()
os.system("xdg-open https://www.facebook.com/broken.hoon.yara?mibextid=ZbWKwL")
xxxx = str(len(ugen))
...
def main():
    ...
    print(f"\033[1;97m[02] \033[1;92mJOIN TO BEST DANISH TELEGRAM")
    ...
    if mirwais in ["1","01"]:
        ...
        os.system("xdg-open https://t.me/best_DANISHs")
        main()
